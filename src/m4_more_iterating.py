...
def run_test_count_items_bigger_than():
    ...
    sequence = [29, 37, 81, 65, 93, 100, 54]
    threshold = 41
    expected = 5
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    expected = 2
    actual = count_positive_sines([9, 61, -3])
    print()
    print('Test 3 expected:', expected)
    print('       actual:  ', actual)
...
def run_test_sum_first_n():
    ...
    expected = 69
    actual = sum_first_n([5, 9, 10, 45, -67], 4)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)

    expected = 25
    actual = sum_first_n([94, -24, -45, 17], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
